...
Escribir un programa donde se ingresa un número que representa el mes y 
se obtiene como salida un mensaje con el nombre del mes y la cantidad de
días que tiene. Declarar la variable numeroDeMes y asignar un valor entre 1 y 12
...
SINO
Mostrar el siguiente mensaje: El mes seleccionado es ${nombreDelMes} y 
