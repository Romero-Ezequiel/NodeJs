...
Los 3 dragones de Game of Thrones se llaman: Drogon, Rhaegal y Viserion, utilizando interpolación de textos
 */
...
let serie = 'Game of Thrones', 
    ...
    dragon2 = 'Rhaegal',
    dragon3 = 'Viserion',
    template = `Los 3 dragones de serie se llaman: ${dragon1}, ${dragon2} y ${dragon3}`;
